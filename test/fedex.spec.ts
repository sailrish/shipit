...
describe('fedex client', () => {
  ...
  beforeAll(() => _fedexClient = new FedexClient({
    key: 'fedex-api-key',
    password: 'password',
    account: 'fedex-user',
  ...
  describe('validateResponse', () => {
    ...
    it(
      'returns an error when there are no success notifications',
      done => {
  ...
  describe('integration tests', () => {
    ...
    describe('delivered package', () => {
      ...
      it(
        'has a service type of fedex priority overnight',
    ...
    describe('in transit package with an activity with missing location', () => {
      ...
      it(
        'has a service type of FedEx SmartPost',
      ...
      it(
        'has a destination of Greenacres, WA',
      ...
      it(
        'has first activity with location Troutdale, OR 97060',
