...
describe('fedex client', function () {
  ...
  describe('validateResponse', function () {
    it('returns an error if response is not an xml document', function (done) {
      ...
      return _fedexClient.validateResponse('bad xml', function (err, resp) {
  ...
  return describe('integration tests', function () {
    ...
    describe('delivered package', function () {
      before(done => fs.readFile('test/stub_data/fedex_delivered.xml', 'utf8', (err, xmlDoc) => _fedexClient.presentResponse(xmlDoc, 'trk', function (err, resp) {
    ...
    return describe('in transit package with an activity with missing location', function () {
      before(done => fs.readFile('test/stub_data/fedex_missing_location.xml', 'utf8', (err, xmlDoc) => _fedexClient.presentResponse(xmlDoc, 'trk', function (err, resp) {
        should.not.exist(err)
        _package = resp
        return done()
      })))
