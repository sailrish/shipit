...
describe('canada post client', () => {
  ...
  beforeAll(() => _canpostClient = new CanadaPostClient({
    username: 'oh canada',
    password: 'zamboni'
  }));
  ...
  describe('delivered package', () => {
    ...
    beforeAll(
      done => fs.readFile('test/stub_data/canada_post_delivered.xml', 'utf8', (err, xmlDoc) => _canpostClient.presentResponse(xmlDoc, 'trk', function (err, resp) {
    ...
    it(
      'has a service type of Expedited Parcels',
      () => expect(_package.service).toBe('Expedited Parcels')
    );

    it(
      'has a destination of T3Z3J7',
  ...
  describe('en-route package', () => {
    ...
    beforeAll(
      done => fs.readFile('test/stub_data/canada_post_en_route.xml', 'utf8', (err, xmlDoc) => _canpostClient.presentResponse(xmlDoc, 'trk', function (err, resp) {
        expect(err).toBeFalsy();
        _package = resp;
        return done();
      }))
  ...
  describe('shipping package', () => {
    ...
    beforeAll(
      done => fs.readFile('test/stub_data/canada_post_shipping.xml', 'utf8', (err, xmlDoc) => _canpostClient.presentResponse(xmlDoc, 'trk', function (err, resp) {
        expect(err).toBeFalsy();
        _package = resp;
        return done();
      }))
  ...
  describe('another delivered package', () => {
    ...
    beforeAll(
      done => fs.readFile('test/stub_data/canada_post_delivered2.xml', 'utf8', (err, xmlDoc) => _canpostClient.presentResponse(xmlDoc, 'trk', function (err, resp) {
        expect(err).toBeFalsy();
        _package = resp;
        return done();
      }))
  ...
  describe('delayed package', () => {
    ...
    beforeAll(
      done => fs.readFile('test/stub_data/canada_post_delayed.xml', 'utf8', (err, xmlDoc) => _canpostClient.presentResponse(xmlDoc, 'trk', function (err, resp) {
        expect(err).toBeFalsy();
        _package = resp;
        return done();
      }))
  ...
  describe("en-route package with a 'departed' activity", () => {
    ...
    beforeAll(
      done => fs.readFile('test/stub_data/canada_post_departed.xml', 'utf8', (err, xmlDoc) => _canpostClient.presentResponse(xmlDoc, 'trk', function (err, resp) {
        expect(err).toBeFalsy();
        _package = resp;
        return done();
      }))
