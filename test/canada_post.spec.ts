...
describe('canada post client', function () {
  ...
  describe('another delivered package', function () {
    ...
    return it('has a status of delivered', () => expect(_package.status).to.equal(STATUS_TYPES.DELIVERED));
  });
  ...
  describe('delayed package', function () {
    ...
    return it('has a status of delayed', () => expect(_package.status).to.equal(STATUS_TYPES.DELAYED));
  });
