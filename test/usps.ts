...
import { UspsClient } from '../lib/usps'
...
describe('usps client', function () {
  ...
  return describe('integration tests', function () {
    ...
    describe('delivered package', function () {
      ...
      it('has a status of shipping', () => expect(_package.status).to.equal(ShipperClient.STATUS_TYPES.DELIVERED))
    ...
    describe('out-for-delivery package', function () {
      ...
      it('has a status of shipping', () => expect(_package.status).to.equal(ShipperClient.STATUS_TYPES.OUT_FOR_DELIVERY))
